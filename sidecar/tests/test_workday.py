...
def _make_job(**overrides: object) -> JobListing:
    defaults: dict[str, object] = {
        ...
        "ats": "workday",
        "apply_url": "https://company.wd5.myworkdayjobs.com/careers/job/12345",
...
class TestWorkdayAdapter:
    ...
    async def test_validate_correct_ats(self) -> None:
        adapter = WorkdayAdapter()
        with patch("src.adapters.workday.validate_file", return_value=(True, "ok")):
    ...
    async def test_validate_wrong_ats(self) -> None:
        ...
        assert any("Expected ats='workday'" in e for e in errors)
    ...
    async def test_submit_no_pw_manager(self) -> None:
        adapter = WorkdayAdapter(pw_manager=None)
