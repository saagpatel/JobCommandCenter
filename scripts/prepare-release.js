...
async function prepareRelease() {
  ...
  try {
    ...
    console.log('\n📦 Updating lock files...')
    exec('pnpm install --lockfile-only', { silent: true })
    ...
    if (answer.toLowerCase() === 'y' || answer.toLowerCase() === 'yes') {
      ...
      console.log(
        '📱 Check GitHub Actions: https://github.com/saagpatel/JobCommandCenter/actions'
      )
      console.log(
        '📦 Draft release will appear at: https://github.com/saagpatel/JobCommandCenter/releases'
      )
      console.log(
